...
const Partnerschaft = (props) => {
    return (
        <div className="partnerschaft-popup" style={{ display: props.show ? "block" : "none" }} >
            <div className="partnerschaft-popup-inner">
                <h2>Werde Partner in unserem Netzwerk</h2>
                <p>Für eine Partnerschaft, kannst du uns über das Formular erreichen.</p>
                ...
                <div>
                    <button className="close" onClick={props.handlePartnerschaft}>
