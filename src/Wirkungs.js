...
const data = [
  ...
  },
  {
    title: "Wirkungsziele:",
    text:
      "Die Zukunft der Bildung gestalten: digitales Lernen und Digitalbildung- Kompetenzen und Wissen vermitteln: für eine kritische, aktive, selbstbestimmte Teilhabe in einer digitalen Welt- Vom Nutzen zum Gestalten: Digitale Alphabetisierung- Digitale Teilhabe für alle, unabhängig von Herkunft, Geschlecht, Religionszugehörigkeit, Alter etc.",
        ...
        <section className="WirkungSection">
          <article className="textArticle">
            ...
            <div className="wirkungsBtnDiv">
              ...
              <button className="wirkRight Btn" onClick={this.handleRight}>
                {" "}
                &rarr;{" "}
              </button>
            </div>
